...
public class LibraryEventsController {
    ...
    private final AsyncRun asyncRun;

    public LibraryEventsController(LibraryEventProducer libraryEventProducer, AsyncRun asyncRun) {
    ...
    @Transactional
    public ResponseEntity<?> postLibraryEvent(@RequestBody @Valid LibraryEvent libraryEvent) throws JsonProcessingException, InterruptedException {
